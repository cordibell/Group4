                    ...
                    HStack{
                        ...
                        ZStack{
                            ...
                            VStack {
                                ...
                                Text("Which initiative specifically aims to increase the number of women in IT?")
                                    .font(.title3)
                                    .foregroundColor(Color.black)
                                    .padding()
                                    .background(RoundedRectangle(cornerRadius: 15)
                                ...
                                VStack {
                                    NavigationLink(destination: question12()) {
                                        HStack {
                                            Text("a) Girls Who Code")
                                                .font(.body)
